...
let questions = [
  ...
  /* {
    ...
    options: [
      ...
      "La somme des courants entrant dans un noeud est égale à la somme des courants sortants de ce noeud."
    ]
  },
  {
    numb: 7,
    question: "Dans quels domaines l'électricité à courant alternatif (AC) est-elle couramment utilisée ?",
    answer: "Pour la distribution de l'énergie, l'éclairage résidentiel et industriel, et les systèmes de transmission d'énergie à longue distance.",
    options: [
      "Dans les batteries et les véhicules électriques.",
      "Pour la distribution de l'énergie, l'éclairage résidentiel et industriel, et les systèmes de transmission d'énergie à longue distance.",
      "Uniquement dans les dispositifs électroniques.",
      "Dans les applications solaires et éoliennes."
    ]
  },
  {
    numb: 8,
    question: "Dans quels domaines l'électricité à courant continu (DC) est-elle couramment utilisée ?",
    answer: "Dans l'électronique, les batteries, les véhicules électriques, les applications solaires et éoliennes, et les systèmes de contrôle.",
    options: [
